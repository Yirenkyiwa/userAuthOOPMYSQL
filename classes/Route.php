...
//including 'UserAuth.php' file 
include_once 'UserAuth.php';

//creating a class called 'formController'
class formController extends UserAuth{

    //declaring properties of the formController class
    public $fullname;
    public $email;
    public $password;
    ...
    //creating a constructor that instantiates a new Dbh class
    public function __construct(){
        $this->db = new Dbh();
    }

      //creating a method called handleForm
